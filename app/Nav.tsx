    ...
    <nav className="w-full z-[99999] transition-all duration-300"> 
      <div className="flex justify-between items-center px-[8%] lg:px-[16%] py-6">
        <Link href="/" className="text-5xl font-bold font-unbounded text-white logo">
            Tech
            <span className="text-[var(--primary-color)] font-unbounded">Pash.</span>
        </Link>
        ...
        <div className={`lg:hidden bg-[#1c1b21] text-white border-y border-[--primary-color] px-[8%] overflow-hidden transition-all duration-500 
            ease-in-out ${
