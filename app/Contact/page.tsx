...
export default function Contact() {
  return (
    <div className="px-[8%] lg:px-[16%] py-16 text-white ">
        <div className="grid lg:grid-cols-2 gap-12 w-full">
            ...
            <p className="text-sm text-gray-400 my-8">
                TechPash turns ideas into clean, powerful web solutions. Let’s build something great—together.
            </p>
          ...
          <div className="flex flex-col space-y-6 justify-center">
            ...
            <div className="contact-col flex items-center space-x-4 border-b border-y-gray-600 pb-5">
                <span className="bg-[#1a1b1f] p-4 border border-[var(--primary-color)] rounded-lg text-[color:var(--primary-color)]">
                    <BiPhone size={24}/>
                </span>
                <div>
                    <p className="text-sm text-gray-400">Phone</p>
                    <p className="font-medium">(+254) 7912 67 482</p>
                </div>
            </div>

            <div className="contact-col flex items-center space-x-4 border-b border-y-gray-600 pb-5">
                <span className="bg-[#1a1b1f] border border-[var(--primary-color)] p-4 rounded-lg text-[color:var(--primary-color)]">
                    <BiEnvelope size={24}/>
                </span>
                <div>
                    <p className="text-sm text-gray-400">Email</p>
                    <p className="font-medium">simonipash@gmail.com</p>
                </div>
            </div>
            ...
            <div className="contact-col flex items-center space-x-4 border-b border-y-gray-600 pb-5">
                ...
                <div>
                    ...
                    <p className="font-medium">www.techpash.com</p>                    
                </div>
            </div>
